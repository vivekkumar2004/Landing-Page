    ...
    <nav className="bg-white/95 border-b border-[#1A2B42]/10 sticky top-0 z-50 px-4 md:px-8 py-4 backdrop-blur-md shadow-sm">
      <div className="max-w-6xl mx-auto flex items-center justify-between gap-4">
        ...
        <div className="hidden md:flex items-center gap-8 lg:gap-10 text-sm font-sans font-medium tracking-[0.02em] text-[#132238]">
          <HashLink to="/#who" className="hover:text-[#2563EB] transition-colors duration-300">
            Eligibility
          </HashLink>

          <HashLink to="/#process" className="hover:text-[#2563EB] transition-colors duration-300">
            The Process
          </HashLink>

          <HashLink to="/#universities" className="hover:text-[#2563EB] transition-colors duration-300">
            Network
          </HashLink>

          <HashLink to="/#faq" className="hover:text-[#2563EB] transition-colors duration-300">
            Institutional FAQ
          </HashLink>
        </div>
      ...
      {isMenuOpen && (
        <div className="md:hidden mt-4 pt-4 border-t border-[#2563EB]/10 flex flex-col gap-4 text-sm font-sans font-medium tracking-[0.02em] text-[#334155]">
          ...
          <HashLink to="/#who" onClick={() => setIsMenuOpen(false)} className="hover:text-[#2563EB]">
            Eligibility
          </HashLink>

          <HashLink to="/#process" onClick={() => setIsMenuOpen(false)} className="hover:text-[#2563EB]">
            The Process
          </HashLink>

          <HashLink to="/#universities" onClick={() => setIsMenuOpen(false)} className="hover:text-[#2563EB]">
            Network
          </HashLink>

          <HashLink to="/#faq" onClick={() => setIsMenuOpen(false)} className="hover:text-[#2563EB]">
            Institutional FAQ
          </HashLink>
        </div>
      )}
